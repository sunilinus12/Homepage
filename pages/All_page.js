...

          {
            collection.map((item, key) => {
              return (
                  ...
                  <View key={key} style={{ width: "50%", height: 35 / 100 * Dimensions.get("screen").height, backgroundColor: "white",borderBottomColor:"#C5C5C5",borderRightColor:"#C5C5C5",borderBottomWidth:1,borderRightWidth:1}}
